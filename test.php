        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Perishable Foods</h2>
                                  ...
                                  <div class="col-lg-8 col-lg-offset-2">
                                      <div class="modal-body">
                                         ...
                                         <div class="portfolio-hover">
                                          ...
                                          require_once "connection.php";
                                           $sql = mysqli_query($conn,"SELECT * FROM donations WHERE FoodType ='Perishable' AND status = '1'");
                                          if(!empty($sql))
                                          {
                                          ...
                                          <h4 class="section-heading"><?php echo $rew["donation_description"];?></h4>
                                          <h4 class="section-heading"><?php echo $rew["donation_quantity"];?></h4>
                                          <h4 class="section-heading"><?php echo $rew["donation_location"];?></h4>
                                          ...
                                          <input type="submit" name="add_to_cart2" style="margin-top: 5px" value="allocate"/>
                                          </div>
                                          </form>
                                          <?php
