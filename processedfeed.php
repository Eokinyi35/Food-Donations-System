        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Processed Foods</h2>
                                  ...
                                  <div class="col-lg-8 col-lg-offset-2">
                                      <div class="modal-body">
                                         ...
                                         <div class="portfolio-hover">
                                          ...
                                          require_once "connection.php";
                                           $sql = mysqli_query($conn,"SELECT * FROM donations WHERE FoodType ='Processed' AND status = '1'");
                                          if(!empty($sql))
                                          {
                                          ...
                                          <input type="submit" name="add_to_cart1" style="margin-top: 5px" value="allocate"/>
                                          </div>
                                          </form>
                                          <?php
