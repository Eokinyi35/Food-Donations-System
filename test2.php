                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <select name="FoodType" id="FoodType">
                                      ...
                                      <option value="Perishable" id="Perishable">Perishable Food</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                 <h5 class="section-heading">Donation Expiry Date</h5>
                                    <input type="date" class="form-control" placeholder="Expiry Date *" name = "expiry_date" id="expiry_date" required data-validation-required-message="Please enter the expiry date.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="container">
