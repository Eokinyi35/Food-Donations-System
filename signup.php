...
<body>
    <section id="sign up" class="bg-light-gray">
      ...
      <div class="container">
            ...
            <div style="position:absolute; top:300px; left:30px; width:400px; height:400px;">
          <div class="col-lg-12 text-center"> 
                <label><font color="black">First name:</font></label> 
                <input type="name" name="FName" placeholder="First name"  class="form-control" style = "width: 200px; left:660px;"/><br/>
                <label><font color="black">Last name:</font></label> 
                <input type="name" name="LName" placeholder="Last name"  class="form-control" style = "width: 200px; left:660px;"/><br/>
                ...
                <input type="tel" name="phoneNo" placeholder="phoneNo"  class="form-control" style = "width: 200px; left:660px;"/><br/>
