        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Perishable Donation</h2>
                ...
                <table align="center" >
                                        ...
                                        <tr>
                                          ...
                                          require_once "connection.php";
                                           $sql = mysqli_query($conn,"SELECT * FROM donations WHERE FoodType = 'Perishable'");
                                          if(!empty($sql))
                                          {
                                            ...
                                            if($row > 0 ) {
                                              ...
                                              echo "<th>Donation Time</th>";
                                              echo "<th>Donor Email</th>";
                                              echo "<th>Donor Location</th>";
                                              echo "</tr>";
                                                     echo "</thead>";
                                               echo "<tbody>";
                                              // output data of each row
                                                ...
                                                echo "<td>" . $row['donation_quantity'] . "</td>";
                                                echo "<td>" . $row['donation_time'] . "</td>";
                                                echo "<td>" . $row['donor_email'] . "</td>";
                                                echo "<td>" . $row['donation_location'] . "</td>";
                                                }
                                                echo "</table>";
                                              }else{
                                                echo "Table is empty";
